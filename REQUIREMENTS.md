...
- **Tailscale** on both machines. The config uses a tailnet address (e.g. `100.64.0.1`) and `http://<host>:7878`. This keeps the agent **off the public internet** — treat it as required, not optional.
