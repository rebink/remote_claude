...
Yes — by `claude` running on the Mini, exactly as if you ran `claude` locally. Patchwire doesn't add any third party to the picture. See [Anthropic's data policy](https://docs.claude.com/en/docs/claude-code/security).
