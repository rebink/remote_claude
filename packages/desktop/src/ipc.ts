...
export interface ProvisionArgs { host: string; user: string; port: number; keyPath: string; agentPort: number; token: string; projectDir: string; project: string; remotePath: string; }
